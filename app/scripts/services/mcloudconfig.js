	...
	(function () {
		return {
			...
			REST_API: {
				...
				NODE: {
					...
					V4: {
						...
						VISUALIZATION_XSF:
							'/download?download_format=xsf&download=False',
						VISUALIZATION_CIF:
							'/download?download_format=cif&download=False',
						VISUALIZATION_JSON:
							'/download?download_format=json&download=False',
			...
			GRID: {
				...
				FILTERS_V2: {
					...
					QUANTUMESPRESSOPW: {
						...
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.quantumespresso.pw.',
					},
					QUANTUMESPRESSOPH: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.quantumespresso.ph.',
					},
					INLINE: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.inline.',
					},
					WANNIER90: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.wannier90',
					},
					EXCITING: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.exciting',
					},
					CP2K: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.cp2k',
					},
					SIESTA: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.siesta',
					},
					YAMBO: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.yambo',
					},
					CODTOOLS: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'calculation.job.codtools',
					},
					...
					STRUCTURES: {
						...
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.structure.StructureData.',
					},
					CIF: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.cif.CifData.',
					},
					PARAMETERS: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.parameter.ParameterData.',
					},
					KPOINTS: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.array.kpoints.KpointsData.',
					},
					UPF: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.upf.UpfData.',
					},
					REMOTE: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.remote.RemoteData.',
					},
					TRAJECTORY: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.array.trajectory.TrajectoryData.',
					},
					BANDS: {
						field: 'type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'data.array.bands.BandsData.',
					},
					ARRAY: {
						field: 'type',
						fieldType: 'STRING',
				...
				FILTERS_V3: {
					...
					QUANTUMESPRESSOPW: {
						...
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'aiida.calculations:quantumespresso.pw',
					},
					QUANTUMESPRESSOPH: {
						field: 'process_type',
						fieldType: 'STRING',
						operator: 'STARTSWITH',
						value: 'aiida.calculations:quantumespresso.ph',
					},
					INLINE: {
						field: 'node_type',
						fieldType: 'STRING',
				...
				NODE_TYPES_ORDER: ['calculation', 'process', 'data', 'code'],
			},
			DATA_PATH: {
				V2: {
					CALCULATION: 'calculations',
			...
			DISPLAY_NAMES: {
				V2: {
					// calculations
					'calculation.job.quantumespresso.matdyn.MatdynCalculation.':
						'Matdyn',
					'calculation.job.castep.castep.CastepCalculation.':
						'Castep',
					'calculation.job.quantumespresso.pw.PwCalculation.':
						'Quantum ESPRESSO-PW',
					'calculation.job.quantumespresso.ph.PhCalculation.':
						'Quantum ESPRESSO-PH',
					'calculation.job.codtools.ciffilter.CiffilterCalculation.':
						'Codtools-ciffilter',
					'calculation.inline.InlineCalculation.':
						'Inline calculation',
					'calculation.job.wannier90.Wannier90Calculation.':
						'Wannier90',
			...
			SIDE_MENU_DEFAULTS: {
				calculation: [
					{
						display_name: 'Inline calculation',
						filter_name: 'calculation.inline.InlineCalculation.',
					},
					{
						display_name: 'Quantum ESPRESSO-PH',
						filter_name:
							'calculation.job.quantumespresso.ph.PhCalculation.',
					},
					{
						display_name: 'Quantum ESPRESSO-PW',
						filter_name:
							'calculation.job.quantumespresso.pw.PwCalculation.',
					},
				],
				code: [{ display_name: 'Code', filter_name: 'code.Code.' }],
				data: [
					{
						display_name: 'Array',
						filter_name: 'data.array.ArrayData.',
					},
					{
						display_name: 'Bands',
						filter_name: 'data.array.bands.BandsData.',
					},
					{
						display_name: 'Kpoints',
						filter_name: 'data.array.kpoints.KpointsData.',
					},
					{
						display_name: 'Trajectory',
						filter_name: 'data.array.trajectory.TrajectoryData.',
					},
					{ display_name: 'Cif', filter_name: 'data.cif.CifData.' },
					{
						display_name: 'Folder',
						filter_name: 'data.folder.FolderData.',
					},
					{
						display_name: 'Parameter',
						filter_name: 'data.parameter.ParameterData.',
					},
					{
						display_name: 'Remote',
						filter_name: 'data.remote.RemoteData.',
					},
					{
						display_name: 'Structure',
						filter_name: 'data.structure.StructureData.',
					},
